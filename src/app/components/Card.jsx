  ...
  return (
    <div className="w-[330px] h-[438px]  ">
      ...
      <div className="flex flex-col items-center justify-around gap-[8px] mt-[8px] ">
        <div className="flex items-center justify-between w-[310px] h-[30px] text-[24px] leading-[30px] text-[#393939] font-playfair">
          <p>Title</p>
          <p className="font-[Geist]">
            0<sup className="text-[14px]">€</sup>
          </p>
        </div>
        <div className="h-[26px] w-[310px] font-[Geist] flex items-center justify-between">
